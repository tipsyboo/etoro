...
*   **Automated Notifications**: Configured an `always` post-build block to send email notifications. The email includes the build status, Helm action, and the dynamic Ingress IP for quick verification.
